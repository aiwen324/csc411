...
\end{figure}
\begin{figure}[h]
    \subfloat[rate 1e-4]{{\includegraphics[width=0.28\textwidth]{report/part864_minibatch_loss1e-4.png}}}
    \qquad
    \subfloat[rate 1e-5]{{\includegraphics[width=0.28\textwidth]{report/part864_minibatch_loss1e-05.png}}}
    \caption{Resolution 64x64, learning curve with rate $10^{-4},10^{-5},10^{-6}$}
\end{figure}
\begin{figure}[H]
    \subfloat[rate 1e-4]{{\includegraphics[width=0.28\textwidth]{report/part864_minibatch_performance1e-4.png}}}
    \qquad
    \subfloat[rate 1e-5]{{\includegraphics[width=0.28\textwidth]{report/part864_minibatch_performance1e-05.png}}}
